...
const DropMenu = React.forwardRef<HTMLDivElement>(({}, ref) => {
  ...
  return (
    <div
      ref={ref}
      className="fixed top-12 hidden h-[calc(100vh-48px)] w-full overflow-scroll border-b-[16px] border-b-beige-100 bg-beige-100"
    >
      <div className="">
        <div className="flex justify-center gap-x-6 border-b border-b-brown-300 py-4 text-brown-700">
          <a href="/" className="flex items-center px-3 py-1 font-semibold">
            Sign in
          </a>
          <a
            href="/"
            className="item-center flex border-2 border-brown-700 px-3 py-1 font-semibold"
          >
            Sign up
          </a>
        </div>
